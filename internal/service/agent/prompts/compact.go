...
const CompactSummaryPrompt = `The messages above are a conversation to summarize, Create a structured context checkpoint summary that another LLM will use to continue the work.
...
- [Or "(none)" if none were memtioned]
